...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '27735940102'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  sessionName: process.env.SESSION_ID || "SESSION_21_59_07_25_ElsinoreCuban
",      //Put Your Session Id Here
  author:  process.env.PACK_AUTHER ||  'Tsepo',
  packname:  process.env.PACK_NAME || 'Slade is being weird again',
  
  botname:   process.env.BOT_NAME === undefined ? "☆Slade☆" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Slade' : process.env.OWNER_NAME,  
